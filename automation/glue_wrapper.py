...
if __name__ == "__main__":
    ...
    client.create_job(
        name='etl-job',
        description='ETL job that transforms data from one format to another.',
        role_arn='arn:aws:iam::123456789012:role/service-role/AWSGlueServiceRole-DefaultRole',
        script_location='s3://my-bucket/jobs/etl-job.py',
        dependencies_s3_uri='s3://my-bucket/jobs/dependencies.zip'
    )