...
class TestBucketEnum:
    def test_enum_values(self):
        assert str(Bucket.LANDING) == "landing-dev-wm"
        assert str(Bucket.RAW) == "project-dev-wm"
        assert str(Bucket.ACCESS) == "project-dev-wm"
        assert str(Bucket.OPTIMISED) == "project-dev-wm"
...
class TestTierEnum:
    def test_enum_values(self):
        assert str(Tier.LANDING) == 'landing'
        assert str(Tier.RAW) == 'raw'      
        assert str(Tier.ACCESS) == 'access'
        assert str(Tier.OPTIMISED) == 'optimised'
...
class TestCreatePath:           
    ...
    def test_create_path_for_different_conditions(self):
        ...
        ) == "file://landing-dev-wm/landing/claim_db/claim/full/most_recent/"
