...
class TestPaths:
    ...
    def test_create_claim_landing_to_raw_full_load_input_path(self):
        ...
        path = etl.jobs.landing.claim.input_path
        assert path ==  f"{Environment.PROD}://{Bucket.LANDING}/{Tier.LANDING}/{Source.CLAIM_DB}/{Table.CLAIM}/{Load.FULL}/202305211851.csv"
    ...
    def test_create_claim_landing_to_raw_full_load_output_path(self):
        ...
        path = etl.jobs.landing.claim.output_path
